...
temp_var = 'tw' #dry or wet bulb heatwaves
restrict = str(10.0)
...
for k in np.arange(5, n_parts):
    ...
    ##save sameday
    save_name = save_path +  'sameday_combinedevents_' + mod + '_' + scen + '_r' + str(restrict) + '_part' + str(k) + '.nc'
    ...
    for i in np.arange(len(sameday_mets)):
        ...
        save_name = save_path +  'sameday_' + var_names[i] + '_' + mod + '_' + scen + '_r' + str(restrict) + '_part' + str(k) + '.nc'
    ...
    for n in np.arange(len(ndays)):
        ...
        save_name = save_path +  'fbefore_' + str(ndays[n]) + '_combinedevents_' + mod + '_' + scen + '_r' + str(restrict) + '_part' + str(k) + '.nc'
        iris.save(fbefore[n], save_name)
        save_name = save_path +  'fafter_' + str(ndays[n]) + '_combinedevents_' + mod + '_' + scen + '_r' + str(restrict) + '_part' + str(k) + '.nc'
    ...
    for n in np.arange(len(ndays)):
        ...
        for i in np.arange(len(fbefore_mets[n])):
            save_name = save_path +  'fbefore_' + str(ndays[n]) + '_' + var_names[i] + '_' + mod + '_' + scen + '_r' + str(restrict) + '_part' + str(k) + '.nc'
            iris.save(fbefore_mets[n][i], save_name)
            save_name = save_path +  'fafter_' + str(ndays[n]) + '_' + var_names[i] + '_' + mod + '_' + scen + '_r' + str(restrict) + '_part' + str(k) + '.nc'
